...
template<typename GenType>
typename bivari_functor<GenType>::func
bivari_normal_distribution_generator(double mu1, double varx1, double mu2, double varx2)
{
    auto gen1 = std::bind(
...
template<typename GenType>
typename bivari_functor<GenType>::functory
bivari_normal_distribution_generator_factory(double varx1, double varx2)
{
